        ...
        private void LoadDanhSachKhachHang()
        {
            ...
            try
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    string imagePath = Path.Combine(@"C:\vidu\vidu\Resources\imgCustomer\", row["ImgCustomer"].ToString());
        ...
        private void btnCapNhat_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(selectedImagePath)) // Nếu có ảnh mới được chọn
                {
                    ...
                    string targetPath = Path.Combine(@"C:\vidu\vidu\Resources\imgCustomer\", newFileName);
